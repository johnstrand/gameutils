...
{
    // The standard Ken Perlin permutation table, repeated twice to avoid index wrapping.
    ...
    [
        ...
        // Repeated to avoid index-out-of-bounds without modulo
        151,160,137, 91, 90, 15,131, 13,201, 95, 96, 53,194,233,  7,225,
        140, 36,103, 30, 69,142,  8, 99, 37,240, 21, 10, 23,190,  6,148,
        247,120,234, 75,  0, 26,197, 62, 94,252,219,203,117, 35, 11, 32,
         57,177, 33, 88,237,149, 56, 87,174, 20,125,136,171,168, 68,175,
    ...
    public static float Fbm(float x, float y, int octaves, float lacunarity = 2f, float gain = 0.5f)
    {
        var value = 0f;
        var amplitude = 0.5f;
        var frequency = 1f;
